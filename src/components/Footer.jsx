...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      ...
      { name: 'Tech Solutions', path: '/services#solutions' },
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                ...
                web and mobile applications, delivering innovative solutions, and providing 
                robust technical support to help businesses thrive in the digital age.
              </p>
